...
import { Paypal, Socials, footerInformation, footerSupport } from '../../utils/menu';
import { Link } from 'react-router-dom';

const Footer = () => {
    return (
        <div className=" box-border  ">
            <footer className='w-full relative top-48   bg-black'>
                <div className="w-[82%] flex text-white mx-36 text-[14px] leading-5 items-start py-14  ">
                    <div className="w-[25%] px-4">
                        ...
                        <div className={contenStyles['content']}>
                            <p>
                                Ninomaxx Concept là thương hiệu bán lẻ với mô hình "One Stop Shop" mang đến cho khách
                                hàng thông điệp đi là đẹp, thời trang sành điệu giá dễ chịu
                            </p>
                    ...
                    <div className="w-[25%] px-4">
                        ...
                        <div
                            class=" box-border mx-auto relative my-0 flex w-full h-[40px] border-[1px] border-solid border-slate-700 rounded-[60px] pb-[7px]"
                            method="post"
                        >
                            <input
                        ...
                        <div className="pb-4 font-semibold pt-[20px]">
